      ...
      {loading ? (
        ...
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
          ...
          <button 
            ...
            className="mt-2 bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-md text-sm transition-colors duration-200"
          >
            Try Again
          </button>
        </div>
        ...
        <>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-800">{stats.totalCourses}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-800">{stats.totalAnnouncements}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-800">{stats.recentContacts}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {/* Quick Action Cards */}
            <Link to="/admin/courses" className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-all duration-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-3 text-base sm:text-lg font-semibold text-gray-800">Manage Courses</h3>
              </div>
              <p className="text-sm sm:text-base text-gray-600 pl-12">Add, edit or remove courses</p>
            </Link>

            <Link to="/admin/announcements" className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-all duration-200">
              <div className="flex items-center mb-3">
                <div className="bg-yellow-100 p-2 sm:p-3 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                ...
                <h3 className="ml-3 text-base sm:text-lg font-semibold text-gray-800">Manage Announcements</h3>
              </div>
              <p className="text-sm sm:text-base text-gray-600 pl-12">Create and update announcements</p>
            </Link>

            <Link to="/admin/contacts" className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-all duration-200">
              <div className="flex items-center mb-3">
                <div className="bg-red-100 p-2 sm:p-3 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                ...
                <h3 className="ml-3 text-base sm:text-lg font-semibold text-gray-800">Manage Contacts</h3>
              </div>
              <p className="text-sm sm:text-base text-gray-600 pl-12">View and respond to contacts</p>
            </Link>

            <Link to="/admin/settings" className="bg-white rounded-lg shadow-md p-4 sm:p-6 hover:shadow-lg transition-all duration-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="ml-3 text-base sm:text-lg font-semibold text-gray-800">Settings</h3>
              </div>
              <p className="text-sm sm:text-base text-gray-600 pl-12">Manage account settings</p>
            </Link>
          </div>
        </>
      )}
